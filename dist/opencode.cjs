...
__export(opencode_exports, {
  WardenPlugin: () => WardenPlugin,
  default: () => opencode_default
});
module.exports = __toCommonJS(opencode_exports);
...
var opencode_default = WardenPlugin;
